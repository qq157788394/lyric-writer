...
[![Version](https://img.shields.io/badge/version-2.0.0-orange)](https://github.com/qq157788394/lyric-writer)

---

## 这是什么

lyric-writer 是一个 Agent Skill，将 Noema Lab《歌词创作教学.md》完整 19 章方法论内化为 AI 的创作能力。用户只需一个模糊的念头（"想写一首关于分手的歌"），AI 即可主动驱动从灵感到定稿的完整 6 阶段渐进式创作流程。
...
```bash
npx skills add qq157788394/lyric-writer
```
...
| Runtime            | 安装路径                              |
| ------------------ | ------------------------------------- |
| Claude Code        | `~/.claude/skills/lyric-writer/`      |
| Trae CN            | `<项目>/.agents/skills/lyric-writer/` |
| Cursor             | `~/.cursor/skills/lyric-writer/`      |
| Codex              | `~/.codex/skills/lyric-writer/`       |
| Gemini CLI         | `~/.gemini/skills/lyric-writer/`      |
| 通用（多 runtime） | `<项目>/.agents/skills/lyric-writer/` |
...
├── README.md                   # 项目说明
├── LICENSE                     # MIT 许可证
├── lyric-writer-skill-design.md # Skill 设计文档
└── references/                 # 参考文档
